...
<aside id="sidebar" class="sidebar">
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-heading">SUMMARIES & Reviews </li>
        <li class="nav-item">
            <a class="nav-link <?php echo active("summaries.php"); ?>" href="/bookreview/admin/summaries.php">
                <i class="bi bi-chat-square-dots"></i>
                <span>Summaries Of Books</span>
            </a>
        </li>
        <li class="nav-item">
